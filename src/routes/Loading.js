  ...
  const pages = [
        ...
        <div className="mt-0 mb-2">
          {
            ...
            requestedMediaPerms.micDenied === false ? (
              <div>
                <p>
                  The Digital Person works best in a quiet environment, when
                  you&apos;re close to your microphone, and your camera is on.
                </p>
                <p>Speak clearly, and in short responses.</p>
              </div>
            ) : (
              <div>
                <p>
                  The Digital Person works best with your microphone on. Enable
                  your microphone at any point during the experience by clicking
                  the microphone icon & allowing the permissions.
                </p>
                <p>Remember to speak clearly, and in short responses.</p>
              </div>
            )
          }
        </div>
    ...
    <div>
      ...
      <div className="row">
        ...
        <div className="mt-0 mb-2">
          Cory will listen to whatever you say. Other options, like typing or
          choosing your responses, are also available.
        </div>
      </div>
    </div>,
    <div>
      ...
      <div className="row">
        ...
        <div className="mt-0 mb-2">
          ...
          supporting content I can show, or hear about the latest updates to the
          UI template that I&apos;m using.
        </div>
      </div>
    </div>,
  ];
          ...
          <div className="col-11 col-md-6 text-center mobile">
            ...
            <div className="row">
              <div>
                <button
                  className={`${
                    connected || page >= pages.length - 1
                      ? "btn btn-dark connected-button"
                      : "btn-unstyled unconnected-button"
                  } m-2`}
                  type="button"
                  disabled={skip}
              ...
              <div>
                <div className="progress mt-1">
                  <div
                    ...
                    aria-label={`${stateName} (${currentStep} out of ${
                      totalSteps - 1
                    })`}
